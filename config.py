...
# Custom satellite dataset (built by prepare_satellite_dataset.py)
__C.DATASETS.SATELLITE                      = edict()
__C.DATASETS.SATELLITE.TAXONOMY_FILE_PATH   = '../satellite_dataset/Satellite.json'
__C.DATASETS.SATELLITE.RENDERING_PATH       = '../satellite_dataset/%s/rendering/%02d.png'  # (sample_name, view_idx)
__C.DATASETS.SATELLITE.VOXEL_PATH           = '../satellite_dataset/%s/model.binvox'         # (sample_name,)
...
__C.DATASET.TRAIN_DATASET                   = 'Satellite'
__C.DATASET.TEST_DATASET                    = 'Satellite'
